--[[
    ...
    👑 HIROSHI 738 — v12 GODMODE EDITION
    💀 "Le script qui fait pleurer les devs anti-cheat"
    
    🎁 18 ONGLETS • 120+ FEATURES • TROLL ULTIME • MULTI-CHEAT
    
    📑 TABS:
     1. 🎯 Aim        — Aimbot complet
     2. 👁️ ESP        — Wallhack ultime
     3. 🖥️ HUD        — Overlay pro
     4. 🌍 World      — Contrôle du monde
     5. 🏃 Player     — Mouvement & body
     6. 🕵️ Stealth    — Anti-détection
     7. 👑 Admin      — Player list & tools
     8. 🎪 Troll      — Troll basique
     9. 💀 Chaos      — Troll avancé & backshots
    10. 🔊 Audio      — Sound trolling
    11. 📸 Visual     — Visual trolling
    12. 💬 Chat       — Chat spam & tricks
    13. 🏗️ Build      — Spawn objects
    14. 🎮 Minigames  — Jeux intégrés
    15. 📊 Stats      — K/D & analytics
    16. 📋 Logs       — Activity log
    17. 🔧 Config     — Save/Load configs
    18. ⚙️ Settings   — Theme & keybinds
]]
